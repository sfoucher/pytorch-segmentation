...
DATASET_ROOT= Path('/home/sfoucher/DEV/geoimagenet/dataset_test/deepglobe_seg')
...
def process():
    ...
    with open('/home/sfoucher/DEV/geoimagenet/b76e46a7-4bea-4281-b802-2e296f97b960/meta.json') as json_file:
        meta = json.load(json_file)
    dataset= {'path': '/home/sfoucher/DEV/geoimagenet/b76e46a7-4bea-4281-b802-2e296f97b960', DATASET_DATA_KEY : meta['patches']}
